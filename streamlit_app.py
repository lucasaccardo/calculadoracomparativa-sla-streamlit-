...
# --- FUNÇÃO PARA APLICAR O FUNDO E CSS (VERSÃO FINAL E ROBUSTA) ---
def aplicar_estilos():
    try:
        ...
        st.markdown(
            ...
            .main-container {{
                background-color: rgba(10, 10, 20, 0.85); /* Um pouco mais escuro e azulado */
                padding: 25px;
                border-radius: 10px;
                border: 1px solid rgba(255, 255, 255, 0.2);
            }}
            /* REGRA CORINGA: Força TUDO dentro do container a ter texto branco e legível */
