...
def aplicar_estilos():
    try:
        ...
        st.markdown(
            ...
            .main-container h1, .main-container h2, .main-container h3, .main-container strong, .main-container .st-emotion-cache-1jicfl2 {{
                color: white;
        ...
        pass # Não aplica estilo se a imagem não for encontrada
