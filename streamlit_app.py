...
def aplicar_estilos():
    try:
        ...
        st.markdown(
            ...
            <style>
            .stApp {{
                /* CORREÇÃO DEFINITIVA: O tipo da imagem foi ajustado para 'image/png' */
...
if st.session_state.tela == "login":
    ...
    **2. Política de Privacidade e Conformidade com a LGPD**
    Em conformidade com a Lei Geral de Proteção de Dados (LGPD, Lei nº 13.709/2018), detalham-se como os dados são tratados...
    """)
    st.markdown("---")
