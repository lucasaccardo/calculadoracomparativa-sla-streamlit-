...
if st.session_state.tela == "login":
    ...
    .login-card { width:320px; max-width:calc(100% - 48px); padding: 20px 18px 18px 18px; border-radius:12px; background: rgba(6,8,12,0.88); box-shadow:0 18px 40px rgba(0,0,0,0.55); border:1px solid rgba(255,255,255,0.04); color:#E5E7EB; position:relative; z-index:2; }
