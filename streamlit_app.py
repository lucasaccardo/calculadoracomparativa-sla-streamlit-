...
# ... (O restante de todas as suas funções continua aqui, exatamente como você enviou) ...
...
if st.session_state.tela == "login":
    # --- CÓDIGO DA TELA DE LOGIN ATUALIZADO PARA CENTRALIZAR ---
...
# ... (O restante do código para as outras telas continua o mesmo das versões anteriores) ...
elif st.session_state.tela == "terms_consent":
    # ... (código da tela de termos)
...
# Para garantir que o código completo esteja aqui, vou colar as seções restantes
# da última versão funcional.
