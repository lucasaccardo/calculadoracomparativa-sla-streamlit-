...
def load_user_db():
    if os.path.exists("users.csv") and os.path.getsize("users.csv") > 0:
        ...
        # Adiciona as novas colunas ao criar o admin inicial
        admin_user = {
...
# --- TELA DE GERENCIAMENTO DE USUÁRIOS (ATUALIZADA) ---
