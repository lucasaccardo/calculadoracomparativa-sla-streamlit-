...
# --- FUNÇÃO PARA APLICAR O FUNDO E CSS (VERSÃO MELHORADA) ---
def aplicar_estilos():
    try:
        ...
        st.markdown(
            ...
            /* Aplica o card translúcido APENAS ao formulário de login e aos containers principais das outras telas */
            [data-testid="stForm"], .main-container {{
            ...
            /* Centraliza a logo na tela de login */
            .login-logo {{
                display: flex;
        ...
        pass # Não aplica estilo customizado se a imagem não for encontrada
...
if st.session_state.tela == "login":
    st.markdown("<div class='login-container'>", unsafe_allow_html=True) # Container para aplicar estilo
...
else: # Para todas as outras telas
    st.markdown("<div class='main-container'>", unsafe_allow_html=True) # Container para aplicar estilo de card
    ...
    # Resto do código para calc_comparativa e calc_simples
    if st.session_state.tela == "calc_comparativa":
